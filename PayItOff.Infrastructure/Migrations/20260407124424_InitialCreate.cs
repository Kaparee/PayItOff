        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewEmailPending = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friends_Users_InviterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupDebts_Users_CreditorId",
                        column: x => x.CreditorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupDebts_Users_DebtorId",
                        column: x => x.DebtorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TransferReference = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Settlements_Users_SenderId",
                        column: x => x.SenderId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExpenseGroups_Expenses_ExpenseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ExpenseItemId = table.Column<int>(type: "integer", nullable: true),
                    ExpenseGroupId = table.Column<int>(type: "integer", nullable: true),
                    UserId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseGroups_ExpenseId",
                table: "ExpenseGroups",
                column: "ExpenseId");

            migrationBuilder.CreateIndex(
                name: "IX_ExpenseItems_ExpenseGroupId",
                table: "ExpenseItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseSplits_ExpenseItemId",
                table: "ExpenseSplits",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friends_InviterId_ReceiverId",
                table: "Friends",
                columns: new[] { "InviterId", "ReceiverId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupDebts_CreditorId",
                table: "GroupDebts",
                column: "CreditorId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupDebts_DebtorId",
                table: "GroupDebts",
                column: "DebtorId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupDebts_GroupId_DebtorId_CreditorId",
                table: "GroupDebts",
                columns: new[] { "GroupId", "DebtorId", "CreditorId" },
                unique: true);
